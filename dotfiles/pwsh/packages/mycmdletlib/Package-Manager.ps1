...
. (Join-Path $PSScriptRoot ".." "admincmdlet" "Use-Administrator-Privilleges.ps1")
#### Package Managers
function Global:Get-Status-Windows-WinGet-Package-Manager {
    if ($_IsWindows) {
...
function Global:Get-Status-Windows-Choco-Package-Manager {
    if ($_IsWindows) {
...
function Global:Get-Status-Windows-Scoop-Package-Manager {
    if ($_IsWindows) {
...
function Global:Get-Status-Linux-Apt-Package-Manager {
    if ($_IsLinux) {
        if (Test-Command apt) {
            return $true
        }
...
function Global:Get-Status-Linux-Nala-Package-Manager {
    if ($_IsLinux) {
...
function Global:Get-Status-Linux-Yum-Package-Manager {
    if ($_IsLinux) {
        if (Test-Command yum) {
            return $true
        }
...
function Global:Get-Status-Linux-Dnf-Package-Manager {
    if ($_IsLinux) {
        if (Test-Command dnf) {
            return $true
        }
...
function Global:Get-Status-Linux-Pacman-Package-Manager {
    if ($_IsLinux) {
...
function Global:Get-Status-Linux-Pacstall-Package-Manager {
    if ($_IsLinux) {
        if (Test-Command pacman) {
            return $true
        }
...
function Global:Get-Status-Linux-Apk-Package-Manager {
    if ($_IsLinux) {
        if (Test-Command apk) {
            return $true
        }
...
function Global:Get-Status-Linux-Flatpak-Package-Manager {
    if ($_IsLinux) {
...
function Global:Get-Status-Linux-Snap-Package-Manager {
    if (Test-IsWSL) {
...
function Global:Get-Status-Brew-Package-Manager {
...
function Global:Get-Status-BrewCask-Package-Manager {
    if ($_IsMacOS) {
        if (Test-Command brew) {
            return $true
        }
...
function Global:Get-Status-Mac-Mas-Package-Manager {
    if ($_IsMacOS) {
        if (Test-Command mas) {
            return $true
        }
...
function Global:Get-Status-Nix-Package-Manager {
...
### Install Package
function Global:Install-Windows-WinGet-Package($package) {
...
function Global:Install-Windows-Choco-Package($package) {
...
function Global:Install-Windows-Scoop-Package($package) {
...
function Global:Install-Linux-Apt-Package($package) {
...
function Global:Install-Linux-Nala-Package($package) {
...
function Global:Install-Linux-Yum-Package($package) {
...
function Global:Install-Linux-Dnf-Package($package) {
...
function Global:Install-Linux-Pacman-Package($package) {
...
function Global:Install-Linux-Pacstall-Package($package) {
...
function Global:Install-Linux-Apk-Package($package) {
...
function Global:Install-Linux-Flatpak-Package($package) {
...
function Global:Install-Linux-Snap-Package($package) {
...
function Global:Install-Brew-Package($package) {
...
function Global:Install-Mac-BrewCask-Package($package) {
...
function Global:Install-Mac-Mas-Package($package) {
...
function Global:Install-Nix-Package($package) {
...
function Global:Update-Linux-Apt-Package-Database() {
    if (Get-Status-Linux-Apt-Package-Manager) {
        if (Test-Command apt)
        {
            apt update -y
...
function Global:Update-Linux-Nala-Package-Database() {
    if (Get-Status-Linux-Nala-Package-Manager) {
        nala update -y
        return $true
    }
...
function Global:Update-Linux-Pacman-Package-Database() {
    if (Get-Status-Linux-Pacman-Package-Manager) {
        pacman -Syy
        return $true
    }
...
function Global:Update-Linux-Apk-Package-Database() {
    if (Get-Status-Linux-Apk-Package-Manager) {
        apk update
        return $true
    }
...
function Global:Update-Brew-Package-Database() {
    if (Get-Status-Brew-Package-Manager) {
        brew update
        return $true
    }
...
function Global:Update-Nix-Package-Database() {
    if (Get-Status-Nix-Package-Manager) {
        nix-channel --update
        return $true
    }
...
### Update Package
function Global:Update-Windows-WinGet-Package($package) {
    if (Get-Status-Windows-WinGet-Package-Manager) {
...
function Global:Update-Windows-Choco-Package($package) {
    if (Get-Status-Windows-Choco-Package-Manager) {
...
function Global:Update-Windows-Scoop-Package($package) {
    if (Get-Status-Windows-Scoop-Package-Manager) {
...
function Global:Update-Linux-Apt-Package($package) {
    if (Get-Status-Linux-Apt-Package-Manager) {
        if (Test-Command apt)
        {
...
function Global:Update-Linux-Nala-Package($package) {
    if (Get-Status-Linux-Nala-Package-Manager) {
...
function Global:Update-Linux-Yum-Package($package) {
    if (Get-Status-Linux-Yum-Package-Manager) {
...
function Global:Update-Linux-Dnf-Package($package) {
    if (Get-Status-Linux-Dnf-Package-Manager) {
...
function Global:Update-Linux-Pacman-Package($package) {
    if (Get-Status-Linux-Pacman-Package-Manager) {
        pacman -Syu $package
        return $true
    }
...
function Global:Update-Linux-Pacstall-Package($package) {
    if (Get-Status-Linux-Pacstall-Package-Manager) {
        pacstall -Up $package
        return $true
    }
...
function Global:Update-Linux-Apk-Package($package) {
    if (Get-Status-Linux-Apk-Package-Manager) {
        apk upgrade $package
        return $true
    }
...
function Global:Update-Linux-Flatpak-Package($package) {
    if (Get-Status-Linux-Flatpak-Package-Manager) {
...
function Global:Update-Linux-Snap-Package($package) {
    if (Get-Status-Linux-Snap-Package-Manager) {
...
function Global:Update-Brew-Package($package) {
    if (Get-Status-Brew-Package-Manager) {
...
function Global:Update-Mac-BrewCask-Package($package) {
    if (Get-Status-BrewCask-Package-Manager) {
...
function Global:Update-Mac-Mas-Package($package) {
    if (Get-Status-Mac-Mas-Package-Manager) {
        mas upgrade $package
        return $true
    }
...
function Global:Update-Nix-Package($package) {
    if (Get-Status-Nix-Package-Manager) {
        nix-env -uA $package
        return $true
    }
...
### Remove Package
function Global:Remove-Windows-WinGet-Package($package) {
    if (Get-Status-Windows-WinGet-Package-Manager) {
...
function Global:Remove-Windows-Choco-Package($package) {
    if (Get-Status-Windows-Choco-Package-Manager) {
...
function Global:Remove-Windows-Scoop-Package($package) {
    if (Get-Status-Windows-Scoop-Package-Manager) {
...
function Global:Remove-Linux-Apt-Package($package) {
    if (Get-Status-Linux-Apt-Package-Manager) {
        if (Test-Command apt)
        {
...
function Global:Remove-Linux-Nala-Package($package) {
    if (Get-Status-Linux-Nala-Package-Manager) {
...
function Global:Remove-Linux-Yum-Package($package) {
    if (Get-Status-Linux-Yum-Package-Manager) {
...
function Global:Remove-Linux-Dnf-Package($package) {
    if (Get-Status-Linux-Dnf-Package-Manager) {
...
function Global:Remove-Linux-Pacman-Package($package) {
    if (Get-Status-Linux-Pacman-Package-Manager) {
        pacman -R $package
        return $true
    }
...
function Global:Remove-Linux-Pacstall-Package($package) {
    if (Get-Status-Linux-Pacstall-Package-Manager) {
        pacstall -R $package
        return $true
    }
...
function Global:Remove-Linux-Apk-Package($package) {
    if (Get-Status-Linux-Apk-Package-Manager) {
        apk del $package
        return $true
    }
...
function Global:Remove-Linux-Flatpak-Package($package) {
    if (Get-Status-Linux-Flatpak-Package-Manager) {
...
function Global:Remove-Linux-Snap-Package($package) {
    if (Get-Status-Linux-Snap-Package-Manager) {
        snap remove $package
        return $true
    }
...
function Global:Remove-Brew-Package($package) {
    if (Get-Status-Brew-Package-Manager) {
...
function Global:Remove-Mac-BrewCask-Package($package) {
    if (Get-Status-BrewCask-Package-Manager) {
...
function Global:Remove-Mac-Mas-Package($package) {
    if (Get-Status-Mac-Mas-Package-Manager) {
...
function Global:Remove-Nix-Package($package) {
    if (Get-Status-Nix-Package-Manager) {
...
### Update All Packages
function Global:Update-All-Windows-WinGet-Packages() {
    if (Get-Status-Windows-WinGet-Package-Manager) {
        winget upgrade --all
        return $true
    }
...
function Global:Update-All-Windows-Choco-Packages() {
    if (Get-Status-Windows-Choco-Package-Manager) {
        choco upgrade -y all
        return $true
    }
...
function Global:Update-All-Windows-Scoop-Packages() {
    if (Get-Status-Windows-Scoop-Package-Manager) {
        scoop update --all
        return $true
    }
...
function Global:Update-All-Linux-Apt-Packages() {
    if (Get-Status-Linux-Apt-Package-Manager) {
        if (Test-Command apt)
        {
            apt upgrade -y
...
function Global:Update-All-Linux-Nala-Packages() {
    if (Get-Status-Linux-Nala-Package-Manager) {
        nala upgrade -y
        nala autoremove -y
        return $true
...
function Global:Update-All-Linux-Yum-Packages() {
    if (Get-Status-Linux-Yum-Package-Manager) {
        yum upgrade -y
        return $true
    }
...
function Global:Update-All-Linux-Dnf-Packages() {
    if (Get-Status-Linux-Dnf-Package-Manager) {
        dnf upgrade -y
        return $true
    }
...
function Global:Update-All-Linux-Pacman-Packages() {
    if (Get-Status-Linux-Pacman-Package-Manager) {
        pacman -Syu
        return $true
    }
...
function Global:Update-All-Linux-Pacstall-Packages() {
    if (Get-Status-Linux-Pacstall-Package-Manager) {
        pacstall -Up
        return $true
    }
...
function Global:Update-All-Linux-Apk-Packages() {
    if (Get-Status-Linux-Apk-Package-Manager) {
        apk upgrade
        return $true
    }
...
function Global:Update-All-Linux-Flatpak-Packages() {
    if (Get-Status-Linux-Flatpak-Package-Manager) {
        flatpak update -y
        return $true
    }
...
function Global:Update-All-Linux-Snap-Packages() {
    if (Get-Status-Linux-Snap-Package-Manager) {
        snap refresh
        return $true
    }
...
function Global:Update-All-Brew-Packages() {
    if (Get-Status-Brew-Package-Manager) {
        brew update
        brew upgrade
        return $true
...
function Global:Update-All-Mac-BrewCask-Packages() {
    if (Get-Status-BrewCask-Package-Manager) {
        brew update --cask
        brew upgrade --cask
        return $true
...
function Global:Update-All-Mac-Mas-Packages() {
    if (Get-Status-Mac-Mas-Package-Manager) {
        mas upgrade
        return $true
    }
...
# Helpers
function Global:Install-Linux-Pacman-Package-Repository($repositoryName) {
...
function Global:Install-Nix-Package-Repository($repositoryName) {
...
# Main Function
function Global:Install-System-Package(
...
function Global:Update-System-Package-Database(
    [Parameter(Mandatory=$false)]
    [Switch] $LinuxApt,
    [Parameter(Mandatory=$false)]
    [Switch] $LinuxNala,
...
function Global:Update-System-Package(
    [Parameter(Mandatory=$true, Position=0)]
    [String] $package,
    [Parameter(Mandatory=$false)]
    [Switch] $WindowsWinGet,
...
function Global:Remove-System-Package(
    [Parameter(Mandatory=$true, Position=0)]
    [String] $package,
    [Parameter(Mandatory=$false)]
    [Switch] $WindowsWinGet,
...
function Global:Update-All-System-Packages() {
