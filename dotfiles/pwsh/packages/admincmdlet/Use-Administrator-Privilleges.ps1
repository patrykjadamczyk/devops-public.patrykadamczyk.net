...
. (Join-Path $PSScriptRoot "Test-IsUserAdministrator.ps1")
# Sudo function
...
function Global:Invoke-FileAsScript(
...
function Global:Invoke-PSElevatedSession {
...
function Global:Use-Administrator-Privilleges (
    [Parameter(Mandatory=$true, Position=0)]
