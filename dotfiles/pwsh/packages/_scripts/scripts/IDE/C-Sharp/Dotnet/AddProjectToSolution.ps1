...
Write-Host "Executing: dotnet sln $invokeSolution add $invokeProject $additionalArguments"

return dotnet sln $invokeSolution add $invokeProject $additionalArguments
