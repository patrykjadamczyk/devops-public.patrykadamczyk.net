...
$additionalArguments = (gum write --placeholder "Specify additional arguments to clean command")

Write-Host "Executing: dotnet clean $invokeProject $additionalArguments"

return dotnet clean $invokeProject $additionalArguments
