...
def --env "pm status yarn" [] {
    return (which yarn | is-not-empty)
}

# Install package using YARN
def --env "pm install yarn" [$package: string] {
    if ((pm status yarn) == false) {
        return false
    }
...
def --env "pm update yarn" [$package: string] {
    if ((pm status yarn) == false) {
        return false
    }
...
def --env "pm uninstall yarn" [$package: string] {
    if ((pm status yarn) == false) {
        return false
    }
...
def --env "pm run-remote yarn" [$package: string] {
    if ((pm status yarn) == false) {
        return false
    }
    ^yarn dlx $package
...
def --env "pm update-lockfile yarn" [] {
    if ((pm status yarn) == false) {
        return false
    }
