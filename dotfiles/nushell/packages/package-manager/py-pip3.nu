...
def --env "pm status pip" [] {
    return ((which pip3 | is-not-empty) or (which pip | is-not-empty))
}

# Install package using PIP
def --env "pm install pip" [$package: string] {
    if ((pm status pip) == false) {
        return false
    }
...
def --env "pm update pip" [$package: string] {
    if ((pm status pip) == false) {
        return false
    }
    if (which pip3 | is-not-empty) {
...
def --env "pm uninstall pip" [$package: string] {
    if ((pm status pip) == false) {
        return false
    }
    if (which pip3 | is-not-empty) {
...
def --env "pm update-lockfile pip" [] {
    if ((pm status pip) == false) {
        return false
    }
