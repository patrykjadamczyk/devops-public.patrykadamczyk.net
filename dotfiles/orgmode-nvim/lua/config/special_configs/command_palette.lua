-- Telescope
table.insert(require('command_palette').CpMenu, {"Telescope",
...
-- LSP Saga
table.insert(require("command_palette").CpMenu, {"LSP Saga",
...
-- File
table.insert(require('command_palette').CpMenu, {"File",
...
-- Help
table.insert(require('command_palette').CpMenu, {"Help",
  { "tips", ":help tips" },
...
-- Vim
table.insert(require('command_palette').CpMenu, {"Vim",
...
-- Dap
table.insert(require('command_palette').CpMenu, {"Dap",
...
-- File
table.insert(require('command_palette').CpMenu, {"File Line Endings",
  {"UNIX Format", ":set ff=unix"},
  {"DOS Format", ":set ff=dos"},
  {"Mac Format", ":set ff=mac"},
})
-- Special Plugin Stuff
table.insert(require('command_palette').CpMenu, {"Plugins Settings",
...
table.insert(require('command_palette').CpMenu, {"Patryk Utilities",
  ...
  {"Open File in NeoVim Config", ":lua require('telescope.builtin').find_files({cwd = vim.fn.stdpath('config'),prompt_prefix='💻 ',prompt_title='NeoVim Config Files'})"},
  {"Format Go File", ":PatGoFormat"},
  {"Format File with LSP", ":lua vim.lsp.buf.format()"},
})
-- Scretch
table.insert(require("command_palette").CpMenu, { "Scratch Files",
...
-- Neorg
table.insert(require("command_palette").CpMenu, { "Neorg",
...
-- OverSeer
table.insert(require("command_palette").CpMenu, { "Overseer - Build System",
  {"Run Task", ":OverseerRun"},
  {"Toggle Output", ":OverseerToggle"},
})
-- Commands
