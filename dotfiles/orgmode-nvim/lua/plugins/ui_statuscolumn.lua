      ...
      require("statuscol").setup({
        ...
        segments = {
          ...
          -- Dap
          {
            ...
            condition = {
              function (args)
                local bufft = vim.api.nvim_buf_get_option(args.buf,"filetype")
                return not (bufft == "NvimTree" or bufft == "Trouble" or bufft == "SidebarNvim")
              end
            },
          },
          -- Todo Comments Signs
          ...
          -- LspSaga Lightbulb column (Code Action)
          {
            sign = {
              name = {
                "SagaLightBulb",
